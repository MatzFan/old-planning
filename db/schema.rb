...
ActiveRecord::Schema.define(version: 20140131142832) do
  ...
  add_index "planning_apps", ["app_postcodes_id"], name: "index_planning_apps_on_app_postcodes_id", using: :btree
  ...
  add_index "planning_apps", ["roads_id"], name: "index_planning_apps_on_roads_id", using: :btree
